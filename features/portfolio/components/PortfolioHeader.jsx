...
import { portfolioNavigation } from "@/features/portfolio/portfolio.data";
...
function MenuButton({ isOpen, onClick }) {
  return (
    <button
      type="button"
      aria-label={isOpen ? "Tutup menu Portfolio" : "Buka menu Portfolio"}
...
function MenuPanel({ onClose }) {
  const navigation = Array.isArray(portfolioNavigation)
    ? portfolioNavigation
    : [];
