...
const supportAdminStats = [
  {
    label: "Form",
    value: "Ready",
    note: "Halaman Support Kami sudah punya form manual.",
    icon: "💚",
  },
  {
    label: "Data",
    value: "Nanti",
    note: "Data support belum masuk database.",
    icon: "🗃️",
  },
  {
    label: "Payment",
    value: "Nanti",
    note: "Payment gateway dan invoice belum aktif.",
    icon: "💳",
  },
  {
    label: "Status",
    value: "Manual",
    note: "Status support masih lewat WhatsApp manual.",
    icon: "📩",
  },
];

const supportAdminTasks = [
  "Menyiapkan tabel data support/donasi.",
  "Menyimpan nama, kontak, nominal, jenis support, dan pesan.",
  "Membuat status support seperti pending, paid, cancelled, dan completed.",
  "Menghubungkan support ke payment gateway atau invoice manual.",
  "Menampilkan riwayat support di dashboard admin.",
];
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl">
          ...
          <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/25">
            ...
            <div className="relative z-10">
              ...
              <h1 className="mt-4 text-4xl font-black leading-[0.96] tracking-[-0.065em] text-white sm:text-6xl">
                Kelola data support Nexarin.
              </h1>

              <p className="mt-4 max-w-2xl text-sm font-medium leading-7 text-slate-300 sm:text-base sm:leading-8">
                Halaman ini masih placeholder admin support. Nanti di sini akan
                ada data support, nominal, kontak, pesan, status pembayaran,
                invoice, dan riwayat dukungan.
              </p>
          ...
          <div className="mt-6 rounded-[34px] border border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/25">
            ...
            <h2 className="mt-4 text-3xl font-black leading-[1] tracking-[-0.06em] text-white">
              Data support dibuat setelah database siap.
            </h2>

            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {supportAdminTasks.map((item, index) => (
                <div
                  key={item}
