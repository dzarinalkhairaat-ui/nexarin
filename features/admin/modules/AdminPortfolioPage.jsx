...
const portfolioAdminStats = [
  {
    label: "Data",
    value: "Static",
    note: "Project portfolio masih dibaca dari file lokal.",
    icon: "📁",
  },
  {
    label: "CRUD",
    value: "Nanti",
    note: "Tambah, edit, hapus project belum aktif.",
    icon: "🛠️",
  },
  {
    label: "Detail",
    value: "Ready",
    note: "Route detail portfolio sudah tersedia.",
    icon: "🧩",
  },
  {
    label: "Media",
    value: "Nanti",
    note: "Upload gambar project belum terhubung storage.",
    icon: "🖼️",
  },
];

const portfolioAdminTasks = [
  "Menyiapkan struktur data portfolio.",
  "Membuat form tambah/edit project.",
  "Menambahkan slug dan detail project.",
  "Menyiapkan gambar utama dan thumbnail project.",
  "Menghubungkan data portfolio ke database.",
];
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl">
          ...
          <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/25">
            ...
            <div className="relative z-10">
              ...
              <h1 className="mt-4 text-4xl font-black leading-[0.96] tracking-[-0.065em] text-white sm:text-6xl">
                Kelola project portfolio Nexarin.
              </h1>

              <p className="mt-4 max-w-2xl text-sm font-medium leading-7 text-slate-300 sm:text-base sm:leading-8">
                Halaman ini masih placeholder admin portfolio. Nanti di sini
                akan ada fitur tambah project, edit project, kategori, tag
                teknologi, ringkasan, gambar, dan detail studi kasus.
              </p>
          ...
          <div className="mt-6 rounded-[34px] border border-white/10 bg-white/[0.045] p-5 shadow-2xl shadow-black/25">
            ...
            <h2 className="mt-4 text-3xl font-black leading-[1] tracking-[-0.06em] text-white">
              CRUD portfolio dibuat setelah database siap.
            </h2>

            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {portfolioAdminTasks.map((item, index) => (
                <div
                  key={item}
