        ...
        <div className="mb-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-white">
              Konversi <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400">PDF ke Excel</span>
            </h1>
          </div>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Tarik data tabel dari dokumen PDF ke dalam spreadsheet Excel dengan rapi dan akurat hanya dalam hitungan detik.{' '}
            <button 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-[2.5rem] w-full max-w-lg p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-4 mb-6 pr-12">
              ...
              <h2 className="text-xl sm:text-2xl font-black text-white leading-tight">Fungsi Fitur PDF ke Excel</h2>
            </div>
            
            <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
              <p>
                Alat <strong>PDF to Excel</strong> dikhususkan untuk mendeteksi data tabel di dalam dokumen PDF Anda dan mengubahnya menjadi format spreadsheet Excel (XLSX) agar mudah diolah kembali.
              </p>
              
              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0" /> Deteksi Tabel Otomatis
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Sistem kami secara cerdas memindai baris dan kolom yang ada pada halaman PDF dan mempertahankan strukturnya, sehingga Anda tidak perlu mengetik ulang data secara manual.
                </p>
              </div>

              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0" /> Siap Digunakan untuk Analisis
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Output berupa file spreadsheet bisa langsung Anda manfaatkan untuk melakukan kalkulasi formula, membuat grafik, dan menggunakan fitur Excel lainnya.
                </p>
              </div>
            </div>
