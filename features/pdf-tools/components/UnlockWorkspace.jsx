...
import { UploadCloud, FileType, CheckCircle2, ArrowLeft, Loader2, Download, FilePlus, X, Unlock , Shield, Zap, Sparkles } from "lucide-react";
        ...
        <div className="mb-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-white">
              Buka Kunci <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-sky-400">PDF</span>
            </h1>
          </div>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Hapus kata sandi atau proteksi keamanan dari dokumen PDF Anda secara permanen dengan cepat dan aman.{' '}
            <button 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-[2.5rem] w-full max-w-lg p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-4 mb-6 pr-12">
              ...
              <h2 className="text-xl sm:text-2xl font-black text-white leading-tight">Fungsi Fitur Unlock PDF</h2>
            </div>
            
            <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
              <p>
                Alat <strong>Unlock PDF</strong> dirancang untuk melepaskan kata sandi atau perlindungan keamanan yang mengunci dokumen Anda.
              </p>
              
              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-400 shrink-0" /> Dapatkan Hak Akses Penuh
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Seringkali Anda membutuhkan file PDF untuk dicetak atau diedit ulang, namun tidak bisa karena file diproteksi oleh pembuatnya. Alat ini akan menghapus restriksi tersebut.
                </p>
              </div>

              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-400 shrink-0" /> Keamanan Privasi Terjamin
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Tidak ada data yang kami simpan di server. Semua proses dekripsi dan pembukaan sandi dilakukan di dalam browser (mesin komputer) Anda sendiri.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 flex flex-col items-center">
              <button 
                onClick={() => setShowInfoModal(false)}
                className="px-6 py-3 bg-blue-500 hover:bg-blue-600 text-slate-950 font-bold rounded-xl transition-colors w-full"
              >
                Saya Mengerti
              </button>
            </div>
