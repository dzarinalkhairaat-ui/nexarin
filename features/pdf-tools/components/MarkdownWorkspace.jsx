...
import { UploadCloud, FileType, CheckCircle2, ArrowLeft, Loader2, Download, FilePlus, X, Code , Shield, Zap, Sparkles } from "lucide-react";
...
export default function MarkdownWorkspace() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 pt-10 sm:pt-16 text-slate-300 selection:bg-purple-500/30 relative">
      <div className="max-w-5xl mx-auto px-6 pb-20 relative z-10">
        <div className="mb-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
          <div className="inline-flex items-center justify-center p-4 rounded-3xl bg-purple-500/10 text-purple-400 mb-6 shadow-[0_0_30px_rgba(255,255,255,0.1)] ring-1 ring-purple-500/20">
            <Code className="w-10 h-10" />
          </div>
          
          <div className="flex items-center justify-center gap-4 mb-4">
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-white">
              PDF ke <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-fuchsia-400">Markdown</span>
            </h1>
          </div>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Ekstrak teks, struktur, dan tabel dari dokumen PDF Anda menjadi format Markdown murni untuk diproses lebih lanjut oleh AI.{' '}
            <button 
          ...
          {selectedFiles.length > 0 ? (
              ...
              <div className="flex flex-col-reverse sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto mt-2">
                {processingState === 'idle' || processingState === 'error' ? (
                  <>
                    ...
                    <button onClick={processFile} className="w-full sm:flex-1 px-10 py-4 bg-gradient-to-r from-purple-500 via-purple-600 to-purple-600 hover:from-purple-600 hover:via-purple-600 hover:to-purple-700 text-white font-bold rounded-2xl transition-all duration-300 shadow-[0_10px_30px_-10px_rgba(255,255,255,0.15)] hover:shadow-[0_10px_40px_-10px_rgba(255,255,255,0.3)] hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3 text-lg border border-purple-400/30">
                      Proses File
                    </button>
                  </>
                  ...
                  <div className="flex flex-col gap-6 items-center w-full mt-4">
                    ...
                    <button 
                      ...
                      className="w-full sm:w-auto px-10 py-4 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-bold rounded-full transition-all duration-300 shadow-[0_10px_20px_-10px_rgba(255,255,255,0.2)] hover:shadow-[0_10px_30px_-10px_rgba(255,255,255,0.4)] hover:-translate-y-0.5 active:scale-95 flex items-center justify-center gap-2 text-lg border border-purple-400/20"
                    >
            ...
            >
              ...
              <button 
                ...
                className="px-8 py-4 bg-purple-500 text-white font-bold rounded-2xl hover:bg-purple-600 transition-all active:scale-95 shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/50 flex items-center gap-2"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-[2.5rem] w-full max-w-lg p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-4 mb-6 pr-12">
              ...
              <h2 className="text-xl sm:text-2xl font-black text-white leading-tight">Fungsi Fitur PDF to Markdown</h2>
            </div>
            
            <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
              <p>
                Alat <strong>PDF ke Markdown</strong> dirancang khusus untuk mempermudah transisi data dari dokumen statis ke format teks murni yang ramah pengembang dan mesin (seperti LLM/AI).
              </p>
              
              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-purple-400 shrink-0" /> Ekstraksi Terstruktur
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Tidak seperti sekadar *copy-paste*, fitur ini berupaya mengenali tajuk (heading), poin-poin (lists), paragraf, dan tabel untuk diubah menjadi sintaks Markdown (.md) secara rapi.
                </p>
              </div>

              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-purple-400 shrink-0" /> Integrasi Cepat
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Sangat cocok bagi pembuat konten, programmer, atau peneliti yang sering membutuhkan konten PDF untuk dimasukkan ke dalam CMS (Content Management System), GitHub, atau disuapkan sebagai *prompt* AI.
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 flex flex-col items-center">
              <button 
                onClick={() => setShowInfoModal(false)}
                className="px-6 py-3 bg-purple-500 hover:bg-purple-600 text-slate-950 font-bold rounded-xl transition-colors w-full"
              >
                Saya Mengerti
              </button>
            </div>
