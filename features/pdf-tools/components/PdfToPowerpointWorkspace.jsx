        ...
        <div className="mb-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-white">
              Konversi <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-500">PDF ke PPT</span>
            </h1>
          </div>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Ubah file PDF Anda menjadi presentasi PowerPoint (PPT/PPTX) yang siap disunting.{' '}
            <button 
              ...
              <div className="flex flex-col-reverse sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto mt-2">
                {processingState === 'idle' || processingState === 'error' ? (
                  ...
                  <div className="flex flex-col gap-6 items-center w-full mt-4">
                    <p className="text-orange-400 font-bold text-xl">File berhasil diproses!</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-[2.5rem] w-full max-w-lg p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-4 mb-6 pr-12">
              ...
              <h2 className="text-xl sm:text-2xl font-black text-white leading-tight">Fungsi Fitur PDF ke PowerPoint</h2>
            </div>
            
            <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
              <p>
                Alat <strong>PDF to PowerPoint</strong> kami memungkinkan Anda untuk mengekstrak isi PDF dan mengubahnya menjadi salindia presentasi (PPT/PPTX).
              </p>
              
              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0" /> Salindia per Halaman
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Setiap halaman dalam dokumen PDF Anda akan dikonversi menjadi satu salindia presentasi yang terpisah, menjaga urutan presentasi Anda tetap teratur.
                </p>
              </div>

              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-orange-500 shrink-0" /> Elemen Terpisahkan
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Semaksimal mungkin, teks dan gambar akan dipisahkan sebagai elemen independen dalam salindia sehingga Anda bebas mengedit, menggeser, dan menghapusnya.
                </p>
              </div>
            </div>
