...
import { UploadCloud, FileType, CheckCircle2, ArrowLeft, Loader2, Download, FilePlus, X, Hash , Shield, Zap, Sparkles } from "lucide-react";
        ...
        <div className="mb-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-white">
              Nomor <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-400">Halaman</span>
            </h1>
          </div>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Sisipkan nomor halaman ke dalam dokumen PDF Anda secara berurutan dengan posisi dan gaya yang dapat dikustomisasi.{' '}
            <button 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-[2.5rem] w-full max-w-lg p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-4 mb-6 pr-12">
              ...
              <h2 className="text-xl sm:text-2xl font-black text-white leading-tight">Fungsi Fitur Nomor Halaman</h2>
            </div>
            
            <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
              <p>
                Alat <strong>Page Numbers</strong> memudahkan Anda menyisipkan penomoran urut ke setiap lembar halaman dokumen PDF secara presisi.
              </p>
              
              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-pink-400 shrink-0" /> Dokumen Lebih Profesional
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Laporan, tugas akhir, atau makalah Anda akan terlihat jauh lebih rapi dan mudah dibaca oleh dosen atau klien berkat adanya penomoran halaman yang konsisten.
                </p>
              </div>

              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-pink-400 shrink-0" /> Posisi Bebas
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Tempatkan nomor di sudut kanan bawah, di tengah bawah, atau sesuaikan margin sesuka hati agar tidak menutupi isi teks dokumen Anda.
                </p>
              </div>
            </div>
