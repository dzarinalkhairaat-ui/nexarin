...
import { UploadCloud, FileType, CheckCircle2, ArrowLeft, Loader2, Download, FilePlus, X, Crop , Shield, Zap, Sparkles } from "lucide-react";
        ...
        <div className="mb-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-white">
              Potong <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-400">PDF</span>
            </h1>
          </div>
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">
            Potong margin putih atau hilangkan area yang tidak diinginkan dari halaman PDF Anda.{' '}
            <button 
          ...
          <div className="relative bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-[2.5rem] w-full max-w-lg p-8 sm:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] animate-in zoom-in-95 duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-4 mb-6 pr-12">
              <div className="p-3 bg-teal-500/10 rounded-2xl text-teal-400 shrink-0">
                <Crop className="w-6 h-6 sm:w-8 sm:h-8" />
              </div>
              <h2 className="text-xl sm:text-2xl font-black text-white leading-tight">Fungsi Fitur Potong PDF</h2>
            </div>
            
            <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
              <p>
                Alat <strong>Potong PDF (Crop PDF)</strong> dirancang untuk menyesuaikan area pandang (*viewport*) dokumen PDF Anda.
              </p>
              
              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-teal-400 shrink-0" /> Hilangkan Margin Berlebih
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Sangat berguna untuk membuang tepi putih (*white space*) yang terlalu lebar pada dokumen *scan* atau *e-book* agar lebih nyaman dibaca di layar HP atau tablet.
                </p>
              </div>

              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-teal-400 shrink-0" /> Standarisasi Ukuran Halaman
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Potong halaman-halaman yang tidak rapi agar memiliki dimensi dan proporsi yang seragam di seluruh isi dokumen.
                </p>
              </div>
            </div>
