            ...
            <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
              ...
              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-400 shrink-0" /> Mempertahankan Format
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Mesin konversi kami berupaya semaksimal mungkin untuk mempertahankan tata letak, font, tabel, dan gambar persis seperti dokumen PDF aslinya.
                </p>
              </div>

              <div className="bg-slate-950 rounded-xl p-4 sm:p-5 border border-slate-800">
                <h4 className="text-white font-bold mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-400 shrink-0" /> Siap Diedit
                </h4>
                <p className="text-xs sm:text-sm text-slate-400">
                  Hasil konversi akan menjadi dokumen Word yang sepenuhnya dapat Anda edit, sangat berguna untuk merevisi dokumen yang sumber aslinya sudah hilang.
                </p>
              </div>
            </div>
