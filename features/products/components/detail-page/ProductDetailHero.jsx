      ...
      {canShowImage ? (
        ...
        <div className="relative z-10 flex h-full w-full flex-col justify-between p-5">
          <div className="flex items-center justify-between gap-3">
            ...
            <span className="rounded-full border border-white/10 bg-slate-950/70 px-3 py-1.5 text-[10px] font-black text-slate-300">
              ★ {safeProduct.rating || "4.8"}
            </span>
          </div>

          <div className="flex items-end justify-between gap-3">
            <div className="flex h-16 w-16 items-center justify-center rounded-[24px] border border-white/10 bg-white/[0.065] text-3xl shadow-xl shadow-black/20 backdrop-blur">
              {safeProduct.icon || "✦"}
            </div>
  ...
  return (
    <section className="relative overflow-hidden px-5 py-8 text-white sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl">
        ...
        <div className="rounded-[34px] border border-white/10 bg-white/[0.045] p-6 text-center shadow-2xl shadow-black/25">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm font-medium leading-7 text-slate-400">
            Produk yang bro buka tidak ada di data Products saat ini.
          </p>

          <Link
            href="/products/semua"
            className="mt-5 inline-flex min-h-12 items-center justify-center rounded-2xl bg-emerald-400 px-5 py-3 text-sm font-black text-slate-950 transition hover:bg-emerald-300"
          >
            Lihat Semua Produk
          </Link>
        </div>
