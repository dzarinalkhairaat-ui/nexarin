...
function ProductFooterLogo() {
  return (
    <Link
      href="/products"
      className="inline-flex items-center gap-3 rounded-[26px] border border-white/10 bg-white/[0.07] px-4 py-3 shadow-xl shadow-black/20 backdrop-blur-xl transition hover:border-emerald-400/25 hover:bg-emerald-400/10"
      aria-label="Nexarin Products"
    >
      <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-emerald-400/25 bg-slate-950 p-1.5 shadow-xl shadow-emerald-400/10">
        <img
...
export default function ProductCategoryFooter() {
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-slate-950 px-5 pb-7 pt-9 text-white sm:px-6 lg:px-8">
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute -right-16 top-8 h-72 w-72 rotate-12 object-contain opacity-[0.035]"
        loading="lazy"
        decoding="async"
      />
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl gap-7 lg:grid-cols-[minmax(0,1fr)_minmax(280px,0.55fr)] lg:items-end">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <h2 className="mt-6 max-w-2xl text-2xl font-black leading-tight tracking-[-0.055em] text-white sm:text-4xl">
            Produk digital by-rins dibuat bertahap, rapi, dan{" "}
            <span className="text-emerald-300">mobile-first.</span>
          </h2>

          <p className="mt-3 max-w-xl text-sm font-medium leading-7 text-slate-400 sm:text-base">
        ...
        <div className="grid gap-4">
          <div className="rounded-[30px] border border-white/10 bg-white/[0.045] p-4 text-center shadow-xl shadow-black/20 backdrop-blur-xl lg:text-left">
          ...
          <Link
            href="/contact"
            className="inline-flex min-h-14 items-center justify-center gap-3 rounded-[30px] border border-emerald-400/20 bg-emerald-400/20 py-2 pl-2 pr-7 text-sm font-black text-white shadow-xl shadow-emerald-400/10 transition hover:bg-emerald-400 hover:text-slate-950"
          >
            <SupportIcon />
        ...
        <div className="h-px w-full bg-gradient-to-r from-transparent via-white/10 to-transparent lg:col-span-2" />
