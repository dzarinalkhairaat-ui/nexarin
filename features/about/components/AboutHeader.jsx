...
import { aboutNavigation } from "@/features/about/about.data";
...
function MenuButton({ isOpen, onClick }) {
  return (
    <button
      type="button"
      aria-label={isOpen ? "Tutup menu About" : "Buka menu About"}
...
function MenuPanel({ onClose }) {
  const navigation = Array.isArray(aboutNavigation) ? aboutNavigation : [];
