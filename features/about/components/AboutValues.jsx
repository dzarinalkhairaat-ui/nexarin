import { aboutValues } from "@/features/about/about.data";
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 text-sm font-medium leading-7 text-slate-400">
              {safeValue.description ||
                "Prinsip ini akan menjadi dasar pengembangan ekosistem Nexarin."}
            </p>
          </div>
        </div>
      </div>
...
export default function AboutValues() {
  const values = Array.isArray(aboutValues) ? aboutValues : [];
