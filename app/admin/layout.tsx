...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (isLoginPage) {
    return <div className="min-h-screen bg-[#080D1A] text-slate-100">{children}</div>;
  }
  ...
  if (!isAdminAuthenticated) {
    return (
      <div className="min-h-screen bg-[#080D1A] flex items-center justify-center px-4">
        <div className="max-w-md p-8 rounded-3xl bg-[#0B1120] border border-rose-500/30 text-center space-y-4 shadow-2xl">
