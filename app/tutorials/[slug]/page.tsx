...
export default function CourseDetailPage() {
  ...
  if (!course) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
        <div className="text-center space-y-4 max-w-md bg-[#0F172A] p-8 rounded-2xl border border-[#1E293B]">
  ...
  return (
    <div className="min-h-screen bg-[#0B1120] text-slate-100 selection:bg-[#2DD4F5]/30">
      ...
      <section className="border-b border-[#1E293B] bg-gradient-to-b from-[#080D1A] to-[#0F172A] py-10 sm:py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              {/* Stats Bar */}
              <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-2 text-xs font-mono text-slate-300">
                ...
                <div className="flex items-center gap-1.5 text-amber-400">
                  ...
                  <span className="text-slate-100 font-bold">{course.rating.toFixed(1)}</span>
            ...
            <div className="p-6 rounded-2xl bg-[#080D1A] border border-[#1E293B] shadow-2xl space-y-5">
              <div className="relative aspect-video rounded-xl overflow-hidden bg-slate-900 border border-slate-800">
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                  <PlayCircle className="w-12 h-12 text-cyan-400 drop-shadow-lg" />
                </div>
              </div>

              {/* Progress if started */}
              {isStarted && (
                <div className="space-y-1.5 p-3 rounded-xl bg-[#0F172A] border border-[#1E293B]">
                  <div className="flex items-center justify-between text-xs font-mono">
                    <span className="text-slate-300">Progres Belajar</span>
              ...
              <div className="space-y-2">
                <Link href={`/tutorials/${course.slug}/${continueLessonSlug}`} className="block">
                  <Button
                    ...
                    size="md"
                    className="w-full font-extrabold text-xs shadow-lg shadow-cyan-500/10"
                  >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            {/* What you'll learn */}
            <section className="p-6 sm:p-8 rounded-2xl bg-[#0F172A] border border-[#1E293B] space-y-4">
            ...
            {/* Requirements */}
            <section className="p-6 rounded-2xl bg-[#0F172A] border border-[#1E293B] space-y-3">
            ...
            <div className="p-6 rounded-2xl bg-[#0F172A] border border-[#1E293B] space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-400 font-mono">{course.instructor.role}</p>
                </div>
              </div>
            ...
            <div className="p-6 rounded-2xl bg-[#0F172A] border border-[#1E293B] space-y-3">
              ...
              <div className="flex flex-wrap gap-1.5">
                {course.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-2.5 py-1 rounded-lg text-[11px] font-mono bg-slate-900 border border-slate-800 text-slate-300"
                  >
                    #{tag}
                  </span>
                ))}
        ...
        {relatedCourses.length > 0 && (
          <section className="space-y-6 pt-10 border-t border-[#1E293B]">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">
