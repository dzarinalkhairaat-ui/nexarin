        ...
        <div className="w-full max-w-[420px] bg-[#0E1626] border border-[#1E293B] rounded-2xl p-7 sm:p-9 shadow-[0_24px_64px_rgba(0,0,0,0.65)] space-y-6 animate-in fade-in zoom-in-95 duration-200">
          <div className="text-center space-y-3">
            <Link href="/" className="inline-flex items-center justify-center group mb-1">
              <div className="p-2.5 rounded-2xl bg-[#080D1A] border border-[#1E293B] group-hover:border-cyan-500/40 transition-colors shadow-inner">
          ...
          {sent ? (
            <div className="space-y-5 text-center py-2 animate-in fade-in">
              ...
              <Link
                href="/login"
                className="w-full h-11 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-100 font-semibold text-xs transition-colors flex items-center justify-center gap-2"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5 text-left">
                <label htmlFor="recovery-email" className="block text-xs font-semibold text-slate-300">
                  Email Terdaftar
                </label>
