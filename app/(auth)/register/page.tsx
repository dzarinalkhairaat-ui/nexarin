  ...
  return (
    <div className="min-h-screen w-full bg-[#080D1A] text-slate-100 flex flex-col justify-between relative overflow-hidden selection:bg-[#2DD4F5]/30">
      ...
      <main className="relative z-10 w-full flex items-center justify-center px-4 py-6 sm:py-10">
        <div className="w-full max-w-[460px] bg-[#0E1626] border border-[#1E293B] rounded-2xl p-7 sm:p-9 shadow-[0_24px_64px_rgba(0,0,0,0.65)] space-y-6 animate-in fade-in zoom-in-95 duration-200">
          {/* Brand Header */}
          ...
          <form onSubmit={handleRegister} className="space-y-3.5">
            ...
            <div className="space-y-1.5 text-left">
              <label htmlFor="customer-name" className="block text-xs font-semibold text-slate-300">
                Nama Lengkap
              </label>
            ...
            {/* Konfirmasi Password */}
            <div className="space-y-1.5 text-left">
              <label htmlFor="customer-confirm-password" className="block text-xs font-semibold text-slate-300">
                Konfirmasi Password
              </label>
              <div className="relative flex items-center">
                <div className="absolute left-3.5 pointer-events-none text-slate-500">
            ...
            <div className="space-y-1.5 text-left">
              <label htmlFor="customer-company" className="block text-xs font-semibold text-slate-300">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 sm:h-12 rounded-xl bg-[#2DD4F5] hover:bg-[#20b8d8] active:scale-[0.99] text-slate-950 font-bold text-xs sm:text-sm tracking-wide shadow-md shadow-[#2DD4F5]/10 transition-all duration-150 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
