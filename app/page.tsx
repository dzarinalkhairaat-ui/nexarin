...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 bg-[#061214]">
      {/* 1. Hero Section */}
      <section className="relative overflow-hidden pt-8 sm:pt-14 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-10 sm:mb-14">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#18D6D0]/10 border border-[#18D6D0]/30 text-[#18D6D0] text-xs font-bold tracking-wide">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.15]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#18D6D0] to-[#49D7A5]">
                Produk Digital
              </span>{" "}
              Siap Pakai.
            </h1>

            <p className="text-sm sm:text-base text-[#A8BCBA] leading-relaxed max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
              <Link href="/ai">
                <Button variant="outline" size="sm" className="rounded-full text-xs font-semibold border-white/[0.10] text-[#A8BCBA] hover:text-white">
                  <Cpu className="w-3.5 h-3.5 mr-1 text-[#18D6D0]" />
                  AI & Agents
                </Button>
              </Link>
              <Link href="/gadget">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <TrendingUp className="w-5 h-5 text-[#18D6D0]" />
            <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">
              Wawasan & Berita Terkini
            </h2>
          </div>
          <Link href="/news" className="text-xs font-bold text-[#18D6D0] hover:underline flex items-center gap-1">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#49D7A5]/15 text-[#49D7A5] text-xs font-mono font-bold border border-[#49D7A5]/30">
              <Sparkles className="w-3.5 h-3.5" />
            ...
            <p className="text-xs sm:text-sm text-[#6F8583] max-w-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-white/[0.08]">
              <div className="flex items-center gap-2">
                <Cpu className="w-5 h-5 text-[#18D6D0]" />
                <h3 className="text-lg font-bold text-white">
                  Artificial Intelligence
                </h3>
              </div>
              <Link href="/ai" className="text-xs font-bold text-[#18D6D0] hover:underline">
                Lihat Kanal AI →
              </Link>
            </div>
                ...
                <Card key={art.id} hoverable className="p-4 flex gap-4 items-center bg-white/[0.035] border-white/[0.08]">
                  ...
                  <div className="min-w-0 flex-1 space-y-1">
                    <Link href={`/article/${art.slug}`}>
                      <h4 className="text-sm font-bold text-white hover:text-[#18D6D0] line-clamp-2 transition-colors">
                        {art.title}
                      </h4>
                    </Link>
                    <span className="text-[11px] text-[#6F8583] font-mono block">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-white/[0.08]">
              <div className="flex items-center gap-2">
                <BookOpen className="w-5 h-5 text-[#49D7A5]" />
                <h3 className="text-lg font-bold text-white">
                  Tutorial & Implementasi
                </h3>
              </div>
              <Link href="/tutorials" className="text-xs font-bold text-[#49D7A5] hover:underline">
            ...
            <div className="space-y-4">
              {tutorialArticles.map((art) => (
                <Card key={art.id} hoverable className="p-4 flex gap-4 items-center bg-white/[0.035] border-white/[0.08]">
                  ...
                  <div className="min-w-0 flex-1 space-y-1">
                    <Link href={`/article/${art.slug}`}>
                      <h4 className="text-sm font-bold text-white hover:text-[#49D7A5] line-clamp-2 transition-colors">
                        {art.title}
                      </h4>
                    </Link>
                    <span className="text-[11px] text-[#6F8583] font-mono block">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-white/[0.035] border border-cyan-500/20 p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-3 max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#18D6D0]/10 text-cyan-400 text-xs font-mono font-bold">
