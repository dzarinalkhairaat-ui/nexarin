...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 bg-[#0B1120]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-10 sm:mb-14">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
              <Link href="/ai">
                <Button variant="outline" size="sm" className="rounded-full text-xs font-semibold border-slate-700 text-slate-300 hover:text-white">
              ...
              <Link href="/shop">
                <Button variant="primary" size="sm" className="rounded-full text-xs font-bold shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {aiArticles.map((art) => (
                <Card key={art.id} hoverable className="p-4 flex gap-4 items-center bg-[#131E32] border-[#1E293B]">
                  <img
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-[#131E32] border border-cyan-500/20 p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl">
          ...
          <Link href="/free-resources">
            <Button variant="primary" size="lg" className="font-bold text-sm shadow-md whitespace-nowrap">
