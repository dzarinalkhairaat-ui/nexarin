    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <CustomerCard className="space-y-4">
          ...
          <div className="p-4 rounded-xl bg-[#0B1120] border border-white/[0.08] space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#64748B] font-mono">License Key:</span>
              <button
                onClick={() => copyKey(license.licenseKey)}
                className="p-1.5 rounded-lg hover:bg-slate-800 text-[#64748B] hover:text-white transition-colors flex items-center gap-1 text-xs"
                title="Salin Key"
              >
          ...
          <div className="grid grid-cols-2 gap-4 text-xs font-mono pt-2 border-t border-white/[0.08] text-[#64748B]">
            <div>
            ...
            <div>
              ...
              <strong className="block text-[#F8FAFC] mt-0.5">
        ...
        <CustomerCard className="space-y-4">
          ...
          <div className="p-4 rounded-xl bg-[#0B1120] border border-white/[0.08] space-y-3">
            <div className="flex items-center justify-between text-xs font-mono">
              <span className="text-[#64748B]">Versi Terinstal:</span>
              <span className="font-bold text-white text-sm">{license.ownedVersion}</span>
            </div>
            <div className="flex items-center justify-between text-xs font-mono">
              <span className="text-[#64748B]">Versi Rilis Terbaru:</span>
          ...
          {hasUpdate ? (
            ...
            <div className="p-3 rounded-xl bg-slate-900 border border-white/[0.08] text-xs text-[#64748B] flex items-center gap-2">
      ...
      <CustomerCard className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-gradient-to-r from-[#0B1120] to-[#131E32] border-cyan-500/20">
        ...
        <Link href="/customer/docs">
          <Button variant="outline" size="sm" className="whitespace-nowrap border-white/[0.10] text-[#94A3B8] hover:text-white">
            Buka Dokumentasi ?
          </Button>
        </Link>
      </CustomerCard>
