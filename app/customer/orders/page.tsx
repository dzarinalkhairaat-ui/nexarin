  ...
  return (
    <div className="space-y-8">
      ...
      {userOrders.length > 0 ? (
            ...
            <CustomerCard key={order.id} className="space-y-4">
                ...
                {order.items.map((item, idx) => (
                  <div key={idx} className="flex items-center justify-between text-xs">
                    <div>
                      ...
                      <span className="text-[11px] text-slate-400 font-mono">Versi {item.version} • Lisensi Lifetime</span>
                    </div>
              ...
              <div className="pt-3 border-t border-slate-800 flex flex-wrap items-center justify-between gap-3">
                <div className="text-xs font-mono text-slate-400">
                  Payment: <strong className="text-slate-200">{order.paymentProvider}</strong> ({order.paymentReference})
                </div>
        ...
        <CustomerCard className="p-12 text-center text-xs text-slate-400">
