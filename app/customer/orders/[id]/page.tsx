    ...
    <div className="space-y-8">
      ...
      <CustomerCard className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/[0.08]">
          <div>
            <span className="text-xs font-mono text-[#64748B]">ID Referensi Pembayaran:</span>
            <p className="text-sm font-mono font-bold text-cyan-400 mt-0.5">{order.paymentReference}</p>
          </div>
          <div className="sm:text-right">
            <span className="text-xs font-mono text-[#64748B]">Status Pembayaran:</span>
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-mono uppercase text-[#64748B] font-bold tracking-wider">
