...
export default function TermsPage() {
  return (
    <div suppressHydrationWarning className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-8 text-slate-700 dark:text-[#94A3B8] leading-relaxed text-sm">
