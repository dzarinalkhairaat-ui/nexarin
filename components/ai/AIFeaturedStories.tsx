...
export function AIFeaturedStories({ articles }: AIFeaturedStoriesProps) {
    ...
    <section className="space-y-6">
      <div className="flex items-center justify-between pb-3 border-b border-white/[0.08]">
        <h3 className="text-lg sm:text-xl font-bold text-white tracking-tight flex items-center gap-2.5">
          ...
          <span>Liputan Khusus &amp; Sorotan Editorial AI</span>
        </h3>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {articles.map((article) => {
          const sourceName = article.source?.name || "Nexarin";
