...
interface TechCategoryNavProps {
  categories: TechCategoryFilter[];
  activeCategory: string;
  onSelectCategory: (id: string) => void;
}

export function TechCategoryNav({
  categories,
  activeCategory,
  onSelectCategory
}: TechCategoryNavProps) {
  return (
    <nav aria-label="Technology Subcategories" className="border-b border-white/[0.08] bg-[#0B1120]/95 backdrop-blur-xl sticky top-16 sm:top-20 z-20">
