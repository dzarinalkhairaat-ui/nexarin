          ...
          <div className="flex items-center gap-3">
            ...
            {isCustomerAuthenticated && customer ? (
              ...
              <div className="hidden sm:flex items-center gap-2">
                <Link
                  href="/login"
                  className="px-3.5 py-2 rounded-xl text-xs font-semibold text-[#94A3B8] hover:text-white hover:bg-white/[0.04]/80 transition-colors"
                >
                  Masuk
                </Link>
                <Link
                  href="/register"
                  className="px-4 py-2 rounded-xl text-xs font-bold bg-[#2DD4F5] hover:bg-[#20b8d8] text-slate-950 /15 active:scale-[0.98] transition-all"
                >
                  Daftar
                </Link>
              </div>
