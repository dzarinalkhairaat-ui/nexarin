  ...
  return (
    <header className="h-16 border-b border-[#1E293B] bg-[#0B1120] px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 shrink-0">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <Link
          href="/shop"
          className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-xs font-medium text-slate-300 hover:text-white hover:border-slate-700 transition-colors"
        >
        ...
        <Link
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#131E32] border border-[#1E293B] hover:border-slate-700 transition-colors"
        >
          <img
          ...
          <div className="hidden lg:block text-left">
            ...
            <span className="text-[10px] text-slate-400 block mt-0.5 leading-none font-mono truncate max-w-[120px]">
