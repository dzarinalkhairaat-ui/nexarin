...
export function ContinueLearningCard({ course, progress }: ContinueLearningCardProps) {
  ...
  return (
    <div className="relative rounded-2xl bg-white/[0.035] border border-white/[0.10] p-5 sm:p-6 backdrop-blur-md group hover:bg-white/[0.055] hover:border-[#18D6D0]/30 transition-all duration-200">
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        {/* Left: Thumbnail & Course Info */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="relative w-24 h-16 sm:w-32 sm:h-20 rounded-xl overflow-hidden bg-[#08191B] border border-white/[0.10] flex-shrink-0">
            <img
            ...
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
              <PlayCircle className="w-7 h-7 text-[#18D6D0]" />
            </div>
          </div>

          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 rounded-lg text-[10px] font-mono font-bold uppercase bg-[#18D6D0]/10 text-[#18D6D0] border border-[#18D6D0]/20">
                Lanjutkan Belajar
              </span>
            ...
            <h3 className="text-base sm:text-lg font-bold text-[#F2FAF9] leading-snug">
              {course.title}
            </h3>

            <p className="text-xs text-[#A8BCBA] font-mono">
              Terakhir diakses: <strong className="text-[#F2FAF9] font-medium">{progress.lastAccessedLessonTitle || "Pelajaran"}</strong>
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row items-stretch sm:items-center gap-4 md:min-w-[280px]">
          <div className="flex-1 space-y-1.5">
            <div className="flex items-center justify-between text-xs font-mono">
              <span className="text-[#A8BCBA] font-medium">
