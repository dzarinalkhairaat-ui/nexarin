...
export function CourseHeroSection({ course }: CourseHeroSectionProps) {
  ...
  return (
    <section className="border-b border-white/[0.08] bg-[#0B1120] py-10 sm:py-16 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            {/* Stats Bar */}
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-3 text-xs font-mono text-slate-300 border-t border-white/[0.08]">
          ...
          {/* Right Column: Floating Action Preview Card */}
          <div
