...
interface GadgetFeaturedStoriesProps {
  articles: Article[];
}

export function GadgetFeaturedStories({ articles }: GadgetFeaturedStoriesProps) {
    ...
    <section className="space-y-6">
      <div className="flex items-center justify-between pb-3 border-b border-white/[0.08]">
        <h3 className="text-lg sm:text-xl font-bold text-white tracking-tight flex items-center gap-2.5">
          ...
          <span>Liputan Khusus &amp; Sorotan Editorial Gadget</span>
        </h3>
      </div>
