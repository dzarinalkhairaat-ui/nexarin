...
interface DigitalAnalysisSectionProps {
  articles: Article[];
}

export function DigitalAnalysisSection({ articles }: DigitalAnalysisSectionProps) {
        ...
        {articles.map((article) => (
          ...
          >
            <div className="flex items-center gap-2 text-[10px] font-mono text-[#7CF2C3] font-bold uppercase">
              ...
              <span>Perspektif Pasar Digital</span>
            </div>
